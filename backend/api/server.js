...
app.use('/api', require('./routes/registro-duenno.route'));
app.use('/api', require('./routes/registro-admin.route'));
app.use('/api', require('./routes/registro-cliente.route'));
app.use('/api', require('./routes/registro-encargado.route'));
app.use('/api', require('./routes/registro-restaurante.route'));